...
func (*TestCommandSpec) LongDesc() string {
	return "Test experiment contains show info"
}

func (*TestCommandSpec) Example() string {
	return "blade create test show --info 'hello world' "
}

func checkTestExpEnv() error {
	commands := []string{"ps", "awk", "grep", "kill", "nohup", "rm"}
